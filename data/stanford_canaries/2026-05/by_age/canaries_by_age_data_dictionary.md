# Canaries By Age Results Data Dictionary

## Files Included

- `canaries_by_age_annualized.csv`: Annualized growth for all occupations by age.
- `canaries_by_age_yoy_change.csv`: Year-over-year change for all occupations by age.
- `canaries_by_age.csv`: Underlying Employment Index series for all occupations by age.
- `canaries_by_age_data_dictionary.md`: Documentation for this package.
...
## `canaries_by_age_annualized.csv`
...
## `canaries_by_age_yoy_change.csv`
