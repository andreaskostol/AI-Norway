# Canaries Age by Anthropic Automation Ratio Composition Results Data Dictionary

## Files Included

- `canaries_anthropic_usage_automation_ratio_composition.csv`: Composition share snapshot for canaries anthropic usage automation ratio composition.
- `canaries_anthropic_usage_automation_ratio_composition_data_dictionary.md`: Documentation for this package.
...
## `canaries_anthropic_usage_automation_ratio_composition.csv`
