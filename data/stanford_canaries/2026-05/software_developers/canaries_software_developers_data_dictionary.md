# Canaries Software Developers Results Data Dictionary

## Files Included

- `canaries_software_developers_annualized.csv`: Annualized growth for software developers by age.
- `canaries_software_developers_yoy_change.csv`: Year-over-year change for software developers by age.
- `canaries_software_developers.csv`: Underlying Employment Index series for software developers by age.
- `canaries_software_developers_data_dictionary.md`: Documentation for this package.
...
## `canaries_software_developers_annualized.csv`
...
## `canaries_software_developers_yoy_change.csv`
...
## `canaries_software_developers.csv`
