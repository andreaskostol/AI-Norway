# Canaries Age by Exposure Results Data Dictionary

## Files Included

- `canaries_age_by_exposure_annualized.csv`: Annualized growth for age by exposure.
- `canaries_age_by_exposure_yoy_change.csv`: Year-over-year change for age by exposure.
- `canaries_age_by_exposure.csv`: Underlying Employment Index series for age by exposure.
- `canaries_age_by_exposure_data_dictionary.md`: Documentation for this package.
...
## `canaries_age_by_exposure_annualized.csv`
...
| `exposure_quintile` | string | facet | Occupational AI exposure quintile label. | `Quintile 1 (least exposed)`, `Quintile 2`, `Quintile 3`, `Quintile 4`, `Quintile 5 (most exposed)` | Exposure quintile labels range from least to most exposed. |
...
## `canaries_age_by_exposure_yoy_change.csv`
