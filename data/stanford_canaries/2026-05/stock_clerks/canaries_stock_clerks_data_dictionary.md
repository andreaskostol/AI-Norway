# Canaries Stock Clerks Results Data Dictionary

## Files Included

- `canaries_stock_clerks_annualized.csv`: Annualized growth for stock clerks by age.
- `canaries_stock_clerks_yoy_change.csv`: Year-over-year change for stock clerks by age.
- `canaries_stock_clerks.csv`: Underlying Employment Index series for stock clerks by age.
- `canaries_stock_clerks_data_dictionary.md`: Documentation for this package.
...
## `canaries_stock_clerks_annualized.csv`
...
## `canaries_stock_clerks_yoy_change.csv`
