"""
Generate 05_quintile_age_sector_wage_2021_2025.mdata.
Same as 04 but with kontantlonn summarize tabulate.
"""
...
OUTPUT_FILE = BASE_DIR / 'microdata-scripts' / 'monthly' / '05_quintile_age_sector_wage_2021_2025.mdata'
...
def generate_month_block(year: int, month: int, inlist_lines: str) -> str:
    ...
    lines.append(f"import db/ARBLONN_LONN_KONTANT_IMP {date} as kontantlonn")
    ...
    lines.append("tabulate ai_q alder_gr sekt, summarize(kontantlonn) flatten")
