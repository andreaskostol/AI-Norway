...
Usage:  python analysis/06_figures/recursive_kiindeks_headline.py
"""
...
PANEL = BASE / "microdata-output" / "09_occ_agedecade_sektor_kpos_2021m01_2026m02_parsed.csv"  # occ x month counts
...
FIRST_CUT, LAST_CUT = "2025-01", "2026-02"  # first and last vintage data-edge
...
be = DB["packages"]["by_exposure"]; ser = be["series"]["sa"]["_"]; dd = be["dates"]
...
print(f"\nVALIDATION vs dashboard.json (sa, full data): "
