# =============================================================================
# microdata_es_decade_agentic_nyjobb.R : Agentic-anchored Poisson event-study
#                                        on derived new-hire count.
# =============================================================================
# Parallel to microdata_es_decade_agentic.R but the outcome is the count of
# new starts per cell-month: hires = round(count * ny_jobb_share). Anchor:
# April 2025 = k=-1. Window: 2023m07 onward (22-month pre-period, BCC).
#
...
# Output: analysis/output/coefficients/coef_microdata_es_decade_agentic_nyjobb.csv
# =============================================================================
