# =============================================================================
# microdata_es_decade_agentic.R : Approach D Poisson event-study
# =============================================================================
# Parallel to microdata_es_decade.R but with k=-1 = April 2025 (the last
# pre-agentic month) and pre-window restricted to 2023m1 onward so the
# pre-period sits entirely in the post-ChatGPT era. Tests whether
# post-May-2025 dynamics break from the existing ChatGPT trajectory.
#
...
#   Window: 2023m1 through end of data (2026m2). Cluster SE at occupation.
#   Private sector.
#
...
# Output: analysis/output/coefficients/coef_microdata_es_decade_agentic.csv
# =============================================================================
