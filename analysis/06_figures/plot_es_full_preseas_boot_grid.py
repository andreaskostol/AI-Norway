"""
plot_es_full_preseas_boot_grid.py

Full-window seasonally adjusted event study with cluster-bootstrap 95%
CI bands, in a 4x4 grid: decade age groups as rows, quintiles Q1, Q2,
Q4, Q5 (each vs Q3) as columns.

Input:  analysis/output/coefficients/coef_microdata_es_decade_q3_full_preseas_boot.csv
Output: analysis/output/figures/figure_es_full_preseas_boot_grid.pdf
"""
...
QUINTILE_TITLES = {1: "Q1 (least exposed)", 2: "Q2", 4: "Q4",
                   5: "Q5 (most exposed)"}
QUINTILE_COLORS = {1: "#C6DBEF", 2: "#9ECAE1", 4: "#2171B5", 5: "#08306B"}
...
def main():
    ...
    for i, a in enumerate(AGE_ORDER):
        for j, q in enumerate(QUINTILE_ORDER):
            ...
            band_alpha = 0.40 if q in (1, 2) else 0.25
    ...
    fig.tight_layout()
    out = os.path.join(FIG_DIR, "figure_es_full_preseas_boot_grid.pdf")
