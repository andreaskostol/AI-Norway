"""plot_microdata_es_decade_agentic_roll12.py

Agentic Poisson event-study with rolling 12-month baseline offset.
Reads coef_microdata_es_decade_agentic_roll12.csv.

Output: analysis/output/figures/figure_microdata_es_decade_agentic_roll12.pdf
"""
...
def main():
    ...
    out = os.path.join(FIG_DIR,
                       "figure_microdata_es_decade_agentic_roll12.pdf")
