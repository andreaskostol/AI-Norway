"""plot_microdata_es_decade_agentic_monthseas.py

Parallel to plot_microdata_es_decade_agentic.py but reads coefficients with
...
Output: analysis/output/figures/figure_microdata_es_decade_agentic_monthseas.pdf
"""
...
def main():
    ...
    out = os.path.join(FIG_DIR,
                       "figure_microdata_es_decade_agentic_monthseas.pdf")
