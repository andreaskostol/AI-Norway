# =============================================================================
# microdata_es_decade_q3_full_preseas_boot.R : Cluster-bootstrap-SE for
...
# Output: analysis/output/coefficients/coef_microdata_es_decade_q3_full_preseas_boot.csv
