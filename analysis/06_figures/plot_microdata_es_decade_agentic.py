"""
plot_microdata_es_decade_agentic.py

Plot the Approach D Poisson event-study coefficients (cell-level, decade
age groups, private sector, k=-1 = April 2025) from
coef_microdata_es_decade_agentic.csv as a 2x2 grid mirroring the existing
ChatGPT-anchored figure.

Output: analysis/output/figures/figure_microdata_es_decade_agentic.pdf
"""
...
BASE_DT = datetime(2025, 5, 1)   # event time k = 0 (May 2025)
...
AGE_ORDER = [1, 2, 3, 4]
# Q3 is the reference; plot Q1, Q2, Q4, Q5
...
def main():
    ...
    out = os.path.join(FIG_DIR,
                       "figure_microdata_es_decade_agentic.pdf")
