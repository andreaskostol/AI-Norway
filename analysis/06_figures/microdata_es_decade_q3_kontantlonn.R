# =============================================================================
# microdata_es_decade_q3_kontantlonn.R : Q3-referenced event-study on
#                                        log(monthly cash earnings).
# =============================================================================
# Parallel to microdata_es_decade_q3.R but the outcome is log(kontantlonn)
# (mean monthly cash pay per worker, NOK). OLS with count weights, since
# Poisson PPML on a cell-mean wage is not the right model.
#
...
# Output: analysis/output/coefficients/coef_microdata_es_decade_q3_kontantlonn.csv
# =============================================================================
