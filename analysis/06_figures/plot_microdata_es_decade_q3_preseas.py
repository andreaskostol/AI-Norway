"""plot_microdata_es_decade_q3_preseas.py

Q3-referenced ChatGPT event-study figure with PRE-PERIOD-estimated
quintile x cal_month seasonal adjustment applied as Poisson offset.

Reads coef_microdata_es_decade_q3_preseas.csv (from the 2-step R script).

Output: analysis/output/figures/figure_microdata_poisson_es_grid_q3_preseas.pdf
"""
...
def main():
    ...
    out = os.path.join(FIG_DIR,
                       "figure_microdata_poisson_es_grid_q3_preseas.pdf")
