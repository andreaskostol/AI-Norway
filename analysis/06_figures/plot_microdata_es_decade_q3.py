...
Q3-referenced version of the ChatGPT-anchored cell-level Poisson
event-study figure. Same layout as figure_microdata_poisson_es_grid.pdf
but Q1/Q2/Q4/Q5 plotted against Q3 instead of Q1, to avoid Q1's
winter-construction seasonality leaking into the relative differences.

Output: analysis/output/figures/figure_microdata_poisson_es_grid_q3.pdf
"""
...
def main():
    ...
    out = os.path.join(FIG_DIR, "figure_microdata_poisson_es_grid_q3.pdf")
