"""
Append February 2026 data from microdata-output/08_alle_2026_02.csv to all
parsed data files.

Identical structure to append_2026_01.py; only the source file and
DATE_JOB / DATE_PERS dates differ. Population aggregates use the same
BEFOLKNING_STATUSKODE 2026-01-01 snapshot as the January run, but the
employment / wage tabulations come from ARBLONN 2026-02-16.

Idempotent: existing 2026-02-16 rows are removed before appending.

Usage:
    python analysis/02_parse/append_2026_02.py
"""
...
SRC = ROOT / "microdata-output" / "08_alle_2026_02.csv"

DATE_JOB = "2026-02-16"
DATE_PERS = "2026-02-16"
