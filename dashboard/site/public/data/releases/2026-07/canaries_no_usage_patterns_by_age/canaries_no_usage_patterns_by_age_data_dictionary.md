# canaries_no_usage_patterns_by_age Data Dictionary

## Files Included

- `canaries_no_usage_patterns_by_age.csv`: Underlying series.
- `canaries_no_usage_patterns_by_age_yoy_change.csv`: Year-over-year change.
- `canaries_no_usage_patterns_by_age_annualized.csv`: Annualized growth.
- `canaries_no_usage_patterns_by_age_data_dictionary.md`: Documentation.
...
Occupations grouped by the share of the occupation's Claude queries classified as augmentative/automative (Handa et al. 2025 via styrk08_usage_groups.csv), following BCC (2025) Figure 3. `No usage` = canaries-sample occupations below the query threshold.
