# canaries_no_hires_electricians Data Dictionary

## Files Included

- `canaries_no_hires_electricians.csv`: Underlying series.
- `canaries_no_hires_electricians_data_dictionary.md`: Documentation.
...
Value columns: Hiring Index (number of new hires) per decade age group for STYRK-08 7411.
