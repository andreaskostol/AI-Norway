# canaries_no_hires_stock_clerks Data Dictionary

## Files Included

- `canaries_no_hires_stock_clerks.csv`: Underlying series.
- `canaries_no_hires_stock_clerks_data_dictionary.md`: Documentation.
...
Value columns: Hiring Index (number of new hires) per decade age group for STYRK-08 4321.
