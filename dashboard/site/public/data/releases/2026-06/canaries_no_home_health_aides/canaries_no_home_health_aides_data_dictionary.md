# canaries_no_home_health_aides Data Dictionary

## Files Included

- `canaries_no_home_health_aides.csv`: Underlying series.
- `canaries_no_home_health_aides_yoy_change.csv`: Year-over-year change.
- `canaries_no_home_health_aides_annualized.csv`: Annualized growth.
- `canaries_no_home_health_aides_data_dictionary.md`: Documentation.
...
Value columns: Employment Index per decade age group for STYRK-08 5322. Per capita divides by the age group's total resident population.
