# canaries_no_composition Data Dictionary

## Files Included

- `canaries_no_composition.csv`: Underlying series.
- `canaries_no_composition_data_dictionary.md`: Documentation.
...
Snapshot at the normalization date: each age-by-exposure cell's share of total sample employment, in percent (raw headcount). Sums to 100.
