# canaries_no_hires_customer_service Data Dictionary

## Files Included

- `canaries_no_hires_customer_service.csv`: Underlying series.
- `canaries_no_hires_customer_service_data_dictionary.md`: Documentation.
...
Value columns: Hiring Index (number of new hires) per decade age group for STYRK-08 4222.
