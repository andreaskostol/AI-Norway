# canaries_no_hires_software_developers Data Dictionary

## Files Included

- `canaries_no_hires_software_developers.csv`: Underlying series.
- `canaries_no_hires_software_developers_data_dictionary.md`: Documentation.
...
Value columns: Hiring Index (number of new hires) per decade age group for STYRK-08 2512+2513+2514+2519.
