# canaries_no_stock_clerks Data Dictionary

## Files Included

- `canaries_no_stock_clerks.csv`: Underlying series.
- `canaries_no_stock_clerks_yoy_change.csv`: Year-over-year change.
- `canaries_no_stock_clerks_annualized.csv`: Annualized growth.
- `canaries_no_stock_clerks_data_dictionary.md`: Documentation.
...
Value columns: Employment Index per decade age group for STYRK-08 4321. Per capita divides by the age group's total resident population.
