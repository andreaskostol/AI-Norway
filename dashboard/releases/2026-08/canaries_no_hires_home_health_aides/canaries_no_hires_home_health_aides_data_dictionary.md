# canaries_no_hires_home_health_aides Data Dictionary

## Files Included

- `canaries_no_hires_home_health_aides.csv`: Underlying series.
- `canaries_no_hires_home_health_aides_data_dictionary.md`: Documentation.
...
Value columns: Hiring Index (number of new hires) per decade age group for STYRK-08 5322.
