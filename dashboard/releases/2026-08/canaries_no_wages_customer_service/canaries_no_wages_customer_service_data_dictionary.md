# canaries_no_wages_customer_service Data Dictionary

## Files Included

- `canaries_no_wages_customer_service.csv`: Underlying series.
- `canaries_no_wages_customer_service_yoy_change.csv`: Year-over-year change.
- `canaries_no_wages_customer_service_annualized.csv`: Annualized growth.
- `canaries_no_wages_customer_service_data_dictionary.md`: Documentation.
...
Value columns: Wage Index (FTE-adjusted average monthly cash wage) per decade age group for STYRK-08 4222.
