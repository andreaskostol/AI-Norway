# canaries_no_public_composition Data Dictionary

## Files Included

- `canaries_no_public_composition.csv`: Underlying series.
- `canaries_no_public_composition_data_dictionary.md`: Documentation.
