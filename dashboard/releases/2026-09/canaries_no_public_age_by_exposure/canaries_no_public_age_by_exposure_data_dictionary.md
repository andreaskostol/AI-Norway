# canaries_no_public_age_by_exposure Data Dictionary

## Files Included

- `canaries_no_public_age_by_exposure.csv`: Underlying series.
- `canaries_no_public_age_by_exposure_yoy_change.csv`: Year-over-year change.
- `canaries_no_public_age_by_exposure_annualized.csv`: Annualized growth.
- `canaries_no_public_age_by_exposure_data_dictionary.md`: Documentation.
