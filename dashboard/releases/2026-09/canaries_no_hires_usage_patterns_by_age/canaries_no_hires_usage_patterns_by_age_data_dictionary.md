# canaries_no_hires_usage_patterns_by_age Data Dictionary

## Files Included

- `canaries_no_hires_usage_patterns_by_age.csv`: Underlying series.
- `canaries_no_hires_usage_patterns_by_age_data_dictionary.md`: Documentation.
...
Facets `usage_pattern` and `age_bucket`; value columns: Hiring Index (number of new hires) per Claude-usage group (Handa et al. 2025 via styrk08_usage_groups.csv), following BCC (2025) Figure 3. `No usage` = canaries-sample occupations below the query threshold.
