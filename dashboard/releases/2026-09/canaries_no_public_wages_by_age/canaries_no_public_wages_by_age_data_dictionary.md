# canaries_no_public_wages_by_age Data Dictionary

## Files Included

- `canaries_no_public_wages_by_age.csv`: Underlying series.
- `canaries_no_public_wages_by_age_yoy_change.csv`: Year-over-year change.
- `canaries_no_public_wages_by_age_annualized.csv`: Annualized growth.
- `canaries_no_public_wages_by_age_data_dictionary.md`: Documentation.
