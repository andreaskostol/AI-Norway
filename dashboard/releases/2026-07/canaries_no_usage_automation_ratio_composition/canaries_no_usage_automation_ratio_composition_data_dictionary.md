# canaries_no_usage_automation_ratio_composition Data Dictionary

## Files Included

- `canaries_no_usage_automation_ratio_composition.csv`: Underlying series.
- `canaries_no_usage_automation_ratio_composition_data_dictionary.md`: Documentation.
