# canaries_no_wages_electricians Data Dictionary

## Files Included

- `canaries_no_wages_electricians.csv`: Underlying series.
- `canaries_no_wages_electricians_yoy_change.csv`: Year-over-year change.
- `canaries_no_wages_electricians_annualized.csv`: Annualized growth.
- `canaries_no_wages_electricians_data_dictionary.md`: Documentation.
...
Value columns: Wage Index (FTE-adjusted average monthly cash wage) per decade age group for STYRK-08 7411.
