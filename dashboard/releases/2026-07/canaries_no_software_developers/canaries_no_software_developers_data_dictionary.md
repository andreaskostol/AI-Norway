# canaries_no_software_developers Data Dictionary

## Files Included

- `canaries_no_software_developers.csv`: Underlying series.
- `canaries_no_software_developers_yoy_change.csv`: Year-over-year change.
- `canaries_no_software_developers_annualized.csv`: Annualized growth.
- `canaries_no_software_developers_data_dictionary.md`: Documentation.
...
Value columns: Employment Index per decade age group for STYRK-08 2512+2513+2514+2519. Per capita divides by the age group's total resident population.
