...
Cash earnings show no divergence by exposure quintile (Appendix Figure~\ref{fig:kontantlonn_by_quintile}); the wage plots are dominated by seasonal patterns (June holiday pay, December bonuses), and the within-firm difference-in-differences estimates (Table~\ref{tab:did_firmfe}) show no large earnings movement. \citet{brynjolfsson2025} and \citet{humlum2026} likewise find no wage divergence over a similar horizon in the US and Denmark. Norway's two-tier bargaining system \citep{bhuller2022}, with sectoral wage floors and strong employment protection, makes the quantity margin the more likely site of adjustment.
