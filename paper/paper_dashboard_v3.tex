...
\begin{abstract}
\noindent
Using monthly registers covering the universe of private-sector employment in Norway from 2021 through early 2026, we study whether employment has shifted away from occupations more exposed to generative AI. We focus on young workers because their employment adjusts fastest through entry and turnover. Selected high-exposure occupations, including software development and customer service, show falling employment among young workers after ChatGPT's release in November 2022. Across the full exposure distribution, however, the most-exposed private-sector quintile does not separate robustly from the least-exposed quintile for workers aged 21 to 30, and we find no comparable gradient in new hires or cash earnings. In light of post-COVID normalization of the economy and broader macroeconomic trends, the aggregate patterns are hard to interpret as an AI shock. The paper documents the data and methods behind a public dashboard (kiindeksen.no) for monthly monitoring of age-differentiated, occupation-specific changes in the labor market.
\end{abstract}
...
New data will show whether the recent occupation-specific patterns persist. That is why the dashboard is part of the empirical contribution. Early AI labor-market monitoring needs the full occupation distribution.
