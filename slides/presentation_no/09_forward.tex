...
\begin{itemize}\setlength{\itemsep}{4pt}
  \item \textbf{Norge er nummer tre i verden i KI-bruk.} 48,6\,\% av arbeidsfør befolkning i 1.\ kvartal 2026, bak bare Emiratene og Singapore. Sverige: 36,1\,\%, Danmark: 31,2\,\%, Finland: 29,5\,\% (Microsoft).
  \item \textbf{Bruken er bred, men grunn.} KI brukes i 68\,\% av yrkene, men i medianyrket bare for en femdel av oppgavene; helautomatisering er begrenset (Google). 49\,\% av yrkene har bruk i minst en firedel av oppgavene (Anthropic).
  \item \textbf{Automatiseringen skjer i bedriftskanalen.} 77\,\% av bedrifts-API-bruken er automatisering, mot rundt 50\,\% i chat; for kodeagenter 79\,\% (Anthropic).
  \item \textbf{Ingen aggregerte utslag ennå, men unge peker seg ut.} Ingen systematisk ledighetsøkning i eksponerte yrker (OpenAI, Anthropic); jobbstartraten for unge inn i eksponerte yrker er ned rundt 14\,\% (Anthropic).
\end{itemize}

\vspace{0.3em}
\footnotesize
Selskapene etterlyser selv utfallsmåling: OpenAI anbefaler at myndigheter investerer i bedre yrkesmåling; Anthropic og Google peker på samme datamangel.
\end{frame}
