...
\begin{itemize}\setlength{\itemsep}{6pt}
  ...
  \item Occupation score: $\beta_{\text{occ}}$ = \textbf{unweighted} mean of $\beta_{\text{task}}$ across the occupation's tasks
  \item O*NET tags tasks as Core / Supplemental; Eloundou et al.\ do not re-weight by either
\end{itemize}
\end{frame}
...
\vspace{1em}
ISCO-08 $=$ STYRK-08 at 4 digits (SSB Notater 17/2011). STYRK 2262 is Farmasøyter.
\end{frame}
...
\vspace{1em}
All five are clean one-to-one in the BLS crosswalk. Exposure spans Q2 to Q5: carpenters at the bottom, ICT operations technicians at the top. SOC titles do not always match the Norwegian title literally (e.g.\ ``Computer Operators'' vs.\ ``Driftsteknikere, IKT'').
\end{frame}
